      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        <Card className="text-center py-12 bg-white dark:bg-gray-800">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/resolution" className="inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors">
